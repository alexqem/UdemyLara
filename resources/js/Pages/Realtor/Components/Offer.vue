<template>
    ...
    <template #header>Offer #{{ offer.id }}
        <span v-if="offer.accepted_at" class="dark:bg-green-900 dark:text-green-200 bg-green-200 text-green-900 p-1 text-sm rounded-md uppercase ml-1">accepeted</span>    
    </template>
      ...
      <section class="flex items-center justify-between">
        ...
        <div>
          <Link  v-if="!isSold"
            class="btn-outline text-xs font-medium" method="put"
